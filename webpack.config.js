...
const clientEntrypoints = [
  ...
  {
    name: 'CLIENT - Datatables',
    entry: './src/client/data-tables/index.tsx',
    filename: 'data-tables', // we'll add the .html suffix to these
    template: './src/client/data-tables/index.html',
  },
];
